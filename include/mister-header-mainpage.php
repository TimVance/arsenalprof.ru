       ...
       /* global $arBannerFilter;
        ...
        $BANNER_IBLOCK_TYPE = COption::GetOptionString("sotbit.b2bshop", "BANNER_IBLOCK_TYPE", "");
	...
	false
        ...
        <?
        $PriceCode=unserialize(COption::GetOptionString("sotbit.b2bshop", "PRICE_CODE", ""));
        $APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRICE_CODE" => $PriceCode[0],//unserialize(COption::GetOptionString("sotbit.b2bshop", "PRICE_CODE", "")),
		"CONVERT_CURRENCY" => "Y",
        "CURRENCY_ID" => "RUB",
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "36000000",
	...
	false
         ...
         <?/*start block news*/
        $NEWS_IBLOCK_TYPE = COption::GetOptionString("sotbit.b2bshop", "NEWS_IBLOCK_TYPE", "");
        $NEWS_IBLOCK_ID = COption::GetOptionString("sotbit.b2bshop", "NEWS_IBLOCK_ID", "");         
         ?>
         <?$APPLICATION->IncludeComponent(
	"bitrix:news", 
	"ms_news_main_page", 
