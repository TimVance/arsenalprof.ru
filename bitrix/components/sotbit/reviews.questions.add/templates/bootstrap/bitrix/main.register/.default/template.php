...
if(screen.width<768)
{
   ...
   if($('#registration_question .confidential-field input[type="checkbox"]').length)
   {
		if($('#registration_question .confidential-field input[type="checkbox"]').attr("checked") == 'checked')
		{
			$('#registration_question .confidential-field').addClass('checked');
			$('#registration_question .confidential-field label').addClass('checked');
		}
	}
</script>
<?$frame->end();?>