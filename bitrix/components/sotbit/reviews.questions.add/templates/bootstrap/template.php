...
global $USER;
global $APPLICATION;?>
<div class="success" style="display:none;"><?=GetMessage(CSotbitReviews::iModuleID."_QUESTIONS_SUCCESS_TEXT")?></div>
...
.add-questions .auth-error{color:<?=$arParams['PRIMARY_COLOR']?>;}
</style>
<?$frame->end();?>