...
global $APPLICATION;
	global $USER;
?>
<div class="row panel-top" id="filter" data-url="<?=$APPLICATION->GetCurPage()?>" data-max-rating="<?=$arParams["MAX_RATING"]?>" data-id-element="<?=$arParams["ID_ELEMENT"]?>" data-site-dir="<?=SITE_DIR?>" data-template="<?=$templateName?>">
	<div class="col-sm-24">
		<div class="border">
		...
		<?if(COption::GetOptionString(CSotbitReviews::iModuleID, "REVIEWS_UPLOAD_IMAGE_".SITE_ID, "")=='Y'):?>
			<div class="checkbox-group">
				...
				<input
					...
					data-value="<?=($arResult['SORT_IMAGES']=="Y")?'Y':'N'?>"
					/> 
