...
$MESS ['REGISTER_SHOW_WHOLESALER_FIELDS'] = "Поля, которые показывать в форме регистрации оптового покупателя";
$MESS ['REGISTER_REQUIRED_WHOLESALER_FIELDS'] = "Поля, обязательные для заполнения в форме регистрации оптового покупателя";
$MESS ['REGISTER_REQUIRED_WHOLESALER_ORDER_FIELDS'] = "Свойства заказа, которые показывать в форме регистрации оптового покупателя";
