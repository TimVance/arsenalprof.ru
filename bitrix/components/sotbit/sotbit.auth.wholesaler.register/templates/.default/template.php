					...
					<noindex>
						<form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="bform" class="register-form"
							...
							<input type="hidden" id="LOGIN" name="REGISTER[LOGIN]" maxlength="50"
							       value="<?= $arResult["VALUES"]['FIELDS']['LOGIN'] ?>"/>
							<div class="tabs">
								<input id="tab1" type="radio" name="TAB"
								       value="USER" <?php echo ($arResult["VALUES"]['FIELDS']['TAB'] == 'USER' || !$arResult["VALUES"]['FIELDS']['TAB']) ? 'checked' : '' ?>>
								<label for="tab1" class="tab1">
									<div class="tab-icon"></div>
									<?php echo Loc::getMessage('SOTBIT_AUTH_TAB1'); ?>
								</label>
								<input id="tab2" type="radio" name="TAB"
								       value="WHOLESALER" <?php echo ($arResult["VALUES"]['FIELDS']['TAB'] == 'WHOLESALER') ? 'checked' : '' ?>>
								...
								<section id="content-tab2">
									<div class="wrap_registr_form">
										<div class="wrap_block">
											...
											if($arResult['PERSON_TYPES']):
												foreach ($arResult['PERSON_TYPES'] as $key => $group):?>
													<section id="content-fields-<?= $group['ID']; ?>"
								...
								<div class="wrap_block">
											...
											<div class="row">
												...
												<div class="col-sm-17 col-md-10 col-lg-11">
													...
													if($arResult["SECURE_AUTH"])
													{
														...
														echo Loc::getMessage("AUTH_SECURE_NOTE") ?>"
														      style="display:none">
									...
									if($arResult["USER_PROPERTIES"]["SHOW"] == "Y")
									{
										foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField)
										{
											...
											{
												if(Option::get('sotbit.missshop', 'SHOW_CONFIDENTIAL_REGISTRATION', 'Y') == 'Y')
												{
													?>
													<div class="row">
														...
														<div class="col-sm-17 col-md-10 col-lg-11 confidential-field">
															...
															<label for="UF_CONFIDENTIAL">
																<?= Loc::getMessage(
                                                                        "REGISTER_CONFIDENTIAL",
                                                                        array(
                                                                           "#LINK#" => $methodIstall . 'confidentiality.php'
                                                                        )
                                                                    ) ?>
															</label>
														</div>
									...
									<div class="col-sm-24">
										...
										<div class="wrap_auth">
											<a class="auth" rel="nofollow"
											   href="<?= $arParams["~AUTH_URL"] ?>"><?= Loc::getMessage("AUTH_AUTH") ?></a>
										</div>
									</div>
								</div>
							</div>
