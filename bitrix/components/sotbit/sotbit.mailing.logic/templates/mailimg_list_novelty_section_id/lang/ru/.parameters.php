...
$MESS["TEMP_NOVELTY_GOODS_TOP_DEFAULT"] = '
    <div style="background-color: #89cbf5; padding: 5px 10px 5px 10px;color: #FFFFFF; margin-bottom: 10px;"><b>Новинки раздела #SECTION_NAME#:</b></div> 
...
$MESS["TEMP_NOVELTY_GOODS_TOP_NOTES"] = ' 
    Переменные раздела:<br />
    #SECTION_ID# - ID раздела <br />
    #SECTION_NAME# - Название раздела <br />
    #SECTION_SECTION_PAGE_URL# - Ссылка на раздел <br />
