...
$MESS['GROUP_PARAM_ORDER_FILLTER'] = 'Выберем заказы по параметрам';     
$MESS['ORDER_FILLTER_DATE_INSERT_TITLE'] = 'Дата создания заказа';
...
$MESS['ORDER_FILLTER_PRICE_NOTES'] = 'Не хватает настроек? Посмотрите сценарий "Универсальная рассылка по заказам" с очень гибкой системой фильтрации.';       
...
$MESS["SUBJECT_DEFAULT"] = 'Заказ доставлен, нам важно ваше мнение о нас!';
$MESS["MESSAGE_DEFAULT"] = '
                ...
                #FORGET_BASKET# 
                <br />
                <p>В благодарность за потраченное время мы дарим Вам купон 5% скидки, который будет действовать 2 дня.</p>
...
$MESS["GROUP_MESSAGE_NOTES"] = '
   ...
   #MAILING_CONFIRM_EMAIL# - для подтверждения почты необходимо ссылки ставить с переменной ?MAILING_CONFIRM_EMAIL=#MAILING_CONFIRM_EMAIL# <br />
