...
$MESS["LAST_LOGIN_TITLE"] = 'Пользователь не заходил на сайт';
...
$MESS["SUBJECT_DEFAULT"] = 'Давно не заходили #USER_NAME#, приглашаем в гости!';
...
$MESS["TABS_SOTBIT_MAILING_INSTRUCTION_DEFAULT"] = '
    <div style="text-align:center">
        <h3>Видео-урок: Маркетинговые рассылки - сценарий Пользователь давно не заходил  </h3> 
        <iframe width="800" height="500" src="//www.youtube.com/embed/mCBpIquooPw?list=PL2fR59TvIPXe8-iafhCqcLK4r1RxzqhST" frameborder="0" allowfullscreen></iframe>
        <br />
        <br />
        <br />
