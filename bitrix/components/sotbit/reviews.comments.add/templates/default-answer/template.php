...
<div class="add-comments">
	<div class="spoiler">
		...
		<?if(COption::GetOptionString(CSotbitReviews::iModuleID, "COMMENTS_EDITOR_".SITE_ID, "")=="Y" && COption::GetOptionString(CSotbitReviews::iModuleID, "COMMENTS_QUOTS_".SITE_ID, "")=="Y" && ($USER->IsAuthorized() || COption::GetOptionString(CSotbitReviews::iModuleID, "COMMENTS_REGISTER_USERS_".SITE_ID, "")!='Y')): ?>
	...
	<div class="spoiler-comments-body">
			...
			<form class="comment" id="add_comment"
				...
				<input
					...
					type="hidden" name="TEMPLATE" value=".default" /> <input
