<?
$MESS["SHS_ONLINE_SHOW_COUNT_BUYERS"] = "Выводить количество онлайн посетителей";
$MESS["SHS_ONLINE_TYPE_COUNT_BUYERS"] = "Тип вывода количества посетителей";
$MESS["SHS_ONLINE_TYPE_COUNT_BUYERS1"] = "Показывать действительное число посетителей";
$MESS["SHS_ONLINE_TYPE_COUNT_BUYERS2"] = "Выводить число посетитилей случайным образом в заданном диапазоне";
$MESS["SHS_ONLINE_TYPE_COUNT_BUYERS_MIN"] = "Количество посетителей ОТ";
$MESS["SHS_ONLINE_TYPE_COUNT_BUYERS_MAX"] = "Количество посетитилей ПО";
$MESS["SHS_ONLINE_IMAGE_WIDTH"] = "Ширина картинок";
$MESS["SHS_ONLINE_IMAGE_HEIGHT"] = "Высота картинок";
$MESS["SHS_ONLINE_TYPE"] = "Тип вывода товаров";
$MESS["SHS_ONLINE_TYPE1"] = "Все товары";
$MESS["SHS_ONLINE_TYPE2"] = "Товары, находящиеся в корзине";
$MESS["SHS_ONLINE_TYPE3"] = "Товары, находящиеся в заказах";
$MESS["SHS_ONLINE_SHOW_CITY"] = "Выводить местоположение посетителя";
$MESS["SHS_ONLINE_CITY_DEFAULT"] = "Города по умолчанию";
$MESS["SHS_ONLINE_CITY_DEFAULT_MOSCOW"] = "Москва";
$MESS["SHS_ONLINE_BASKET"] = "Корзина";
$MESS["SHS_ONLINE_USERS"] = "Посетители";
$MESS["SHS_ONLINE_PRICES"] = "Цены";
$MESS["SHS_ONLINE_PRICE_CODE"] = "Тип цены";
$MESS["SHS_ONLINE_CONVERT_CURRENCY"] = "Конвертировать валюту";
$MESS["SHS_ONLINE_CURRENCY_ID"] = "Валюта, в которую будут сконвертированы цены:";
$MESS["SHS_ONLINE_ELEMENT_COUNT"] = "Количество выводимых товаров";
$MESS["SHS_ONLINE_JQUERY"] = "Подключить JQuery";
$MESS["SHS_ONLINE_SHOW_NAME"] = "Выводить название";
$MESS["SHS_ONLINE_PRODUCT_NAME"] = "Товара";
$MESS["SHS_ONLINE_OFFER_NAME"] = "Предложения";
$MESS["SHS_ONLINE_SITE"] = "Выберите сайт";
$MESS["SHS_ONLINE_TYPE_MODE"] = "Использовать вывод товаров с помощью bitrix:catalog.top";
