...
/*
?>
<script src="<?=CUtil::GetAdditionalFileURL($templateFolder.'/js/jquery.maskedinput.min.js', true)?>" type="text/javascript"></script>
*/?>
...
<div class="detail_block_back_call sotbit_order_phone">
	...
	?>
		...
		<div class="wrap_input">
			<input class="back_call back_call_submit" type="submit" value="<?=$arParams["SUBMIT_VALUE"]?>" name="s">
		</div>
	</form>
</div>
<script type="text/javascript">
	//$(function() {
		if(typeof msPhonePreviewDetail != "undefined")
		{
			msPhonePreviewDetail.destroy();
			delete msPhonePreviewDetail;
		}
		msPhonePreviewDetail = new msOrderPhonePreviewDetail();
	//})
</script>