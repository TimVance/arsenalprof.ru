...
<div class="sotbit_mailing_subscr_wrap">                    
    <div class="sotbit_mailing_subscr_wrap_in">
        ...
        <form id="sotbit_mailing_subsrib" class="mailing__form" method="post" action="#">
            <input type="email" value="<?=$arResult['SUBSCRIBER_INFO']['EMAIL_TO']?>" name="EMAIL_TO" title="<?=GetMessage('PANNEL_EMAIL')?>" placeholder="<?=GetMessage('PANNEL_EMAIL')?>" class="sotbit_mailing_subscr_wrap_email">
            ...
            <input class="submit" type="submit" value="<?=GetMessage('PANNEL_SEND')?>" >
...
$("#sotbit_mailing_subsrib").on('submit', function(){                                                                        
    ...
    if(email == "<?=GetMessage('AUTH_REGISTER_PANNEL_EMAIL')?>") {
         var email = "";
        $('.sotbit_mailing_subscr_wrap_answer').html('Заполните E-mail!');
    }
