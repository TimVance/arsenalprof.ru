						...
						<div class="row">
							...
							<div class="col-sm-15 col-md-16 col-lg-16">
								<input
									...
									value="<?if(in_array($arProperties['CODE'], array('POST_ZIP','POST_CITY','POST_ADDRESS')) && trim($arProperties["VALUE"]) == '') {echo '';} else echo $arProperties["VALUE"];?>"
									name="<?=$arProperties["FIELD_NAME"]?>"
									id="<?=$arProperties["FIELD_NAME"]?>"
				...
				elseif ($arProperties["TYPE"] == "TEXTAREA")
				{
					...
					<div class="wrap_field <?php if(in_array($arProperties['CODE'], array('POST_ZIP','POST_CITY','POST_ADDRESS'))) echo 'post-field';?>" <?php if(in_array($arProperties['CODE'], array('POST_ZIP','POST_CITY','POST_ADDRESS')) && $eqPost) echo 'style="display:none;"';?>>
						<div class="row">
							...
							<div class="col-sm-15 col-md-16 col-lg-16">
								<textarea rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?if(in_array($arProperties['CODE'], array('POST_ZIP','POST_CITY','POST_ADDRESS')) && trim($arProperties["VALUE"]) == '') {echo 'test-test';} else echo $arProperties["VALUE"];?></textarea>
							</div>
						</div>
					</div>
					<?
