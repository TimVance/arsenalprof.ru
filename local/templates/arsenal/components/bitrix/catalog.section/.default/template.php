...
<div class="catalog__card_wrap <? if(empty($_COOKIE["catalog_view"]) || $_COOKIE["catalog_view"] == 'table') echo 'catalog__card_tab '; ?>catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
				...
				switch ($rowData['VARIANT'])
				{
					...
					case 3:
						?>
						<div class="col-xs-12 product-item-small-card test4">
							<div class="row">
								<?
								foreach ($rowItems as $item)
								{
					...
					case 6:
						?>
						<div class="col-xs-12 product-item-small-card test5">
							<div class="row">
								<?
								foreach ($rowItems as $item)
								{
