						...
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="wrap-title">
										<p class="menu-inner-title">
											<?if($arItem["BRANDS"] && is_array($arItem['BRANDS'])) :?>
												<a href="/brands/" rel="nofollow">
													<?=GetMessage('MS_MENU_TOP_BRANDS_TITLE')?>
												</a>
											<?endif;?>
										</p>
							...
							<div class="row">
											  ...
											  $nBrand = COption::GetOptionString("sotbit.b2bshop", "COUNT_BRAND_MENU", "10");
											  ?>
												...
												<?
														...
														<?if($arItem["BANNER"]["DOP_SECTION"]):?>
															<div class="col-sm-<?=$countToWidth;?> <?if($countToWidth==13): echo('col-sm-offset-1'); endif;?>">
																...
																<div class="title-dop-text"><? echo($arItem["BANNER"]["DOP_SECTION"]); ?></div>
														 	</div>
														<?endif;?>
...
<!--											<div class="row">-->
											<div class="">
												...
												<?foreach($arItem["BANNER"]["CATALOG_ELEMENT"] as $CatalogItem):?>
													...
													<div class="col-sm-12 sm-padding-right-no">
														<a class="wrap-element wrap-element--small" href="<?=$CatalogItem["DETAIL_PAGE_URL"]?>">
															...
															<?endif;?>
															<?if($CatalogItem["MIN_PRICE"]["DISCOUNT"]):?>
																<span class="topmenu-item__discount_value topmenu-item__discount_value--small">-<?=$CatalogItem["MIN_PRICE"]["DISCOUNT"]?>%</span>
															<?endif;?>
															<? if(isset($CatalogItem['ARTICLE'])) { ?>
																<span class="wrap-article">
															<span class="article-name"><?=GetMessage('MS_MENU_TOP_ARTICLE')?>: <?=$CatalogItem['ARTICLE']?></span>
														</span>
															<? } ?>
								...
								<?endif;?>
							<? } elseif($arItem["BANNER"]["ADD_LEFT_TEXT"] == NULL && $arItem["BANNER"]["CATALOG_ELEMENT"]["0"]) { ?>
								<div class="row">
									<div class="col-sm-24">
										<div class="">
											<?$cnt = 0?>
											<?foreach($arItem["BANNER"]["CATALOG_ELEMENT"] as $CatalogItem):?>
												<?$cnt++; //var_dump($CatalogItem);
												if($cnt > 2) break;?>
												<div class="col-sm-12 sm-padding-right-no">
													<a class="wrap-element" href="<?=$CatalogItem["DETAIL_PAGE_URL"]?>">
														...
														<?endif;?>
														<?if($CatalogItem["MIN_PRICE"]["DISCOUNT"]):?>
															<span class="topmenu-item__discount_value">-<?=$CatalogItem["MIN_PRICE"]["DISCOUNT"]?>%</span>
														<?endif;?>
														<? if(isset($CatalogItem['ARTICLE'])) { ?>
														<span class="wrap-article">
															<span class="article-name"><?=GetMessage('MS_MENU_TOP_ARTICLE')?>: <?=$CatalogItem['ARTICLE']?></span>
