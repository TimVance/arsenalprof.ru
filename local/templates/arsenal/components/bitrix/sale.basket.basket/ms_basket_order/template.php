...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
    ...
    <?
    if(isset($arResult["ITEMS"]["AnDelCanBuy"]) && empty($delayClass))
    ...
    <div class="row">
        <div class="col-sm-9 col-sm-offset-15 sm-padding-right-no">
            <div class="wrap_basket_order">
                <a onclick="go_offer_book(this)" rel="nofollow" href="javascript:void(0)" class="basket_order_btn"><?=GetMessage("MS_BASKET_TO_ORDER")?></a>
            </div>
        </div>
    </div>
</div>
